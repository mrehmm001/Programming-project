  ...
  this.draw = function() {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      if (previous != null
        ...
        rect(this.mapYearToWidth(previous.year),this.layout.bottomMargin,this.mapYearToWidth(current.year)-this.mapYearToWidth(previous.year),this.layout.topMargin-507);  
        // fill( ??? );
        // rect( ??? );
